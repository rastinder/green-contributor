...
Generated at: 2025-03-23 05:00:28
...
def analyze_csv(file_path: str, column_name: str) -> Dict[str, Union[float, int]]:
    """
    Analyze a CSV file to compute the mean, median, and mode of a specified column.
    ...
    StatisticsError: If the mode cannot be computed (e.g., all values are unique).
    """
    try:
        ...
        print(f"Error: Cannot compute mode - {e}")

# Example usage:
# results = analyze_csv('data.csv', 'age')
# print(results)
