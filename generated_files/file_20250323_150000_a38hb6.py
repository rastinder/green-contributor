...
Generated at: 2025-03-23 15:00:05
...
def process_sales_data(file_path: str) -> Dict[str, Union[int, float]]:
    ...
    Returns:
        Dict[str, Union[int, float]]: A dictionary where keys are product names and values are the total sales for each product.
    ...
    try:
        with open(file_path, mode='r', newline='', encoding='utf-8') as csvfile:
            ...
            if not expected_columns.issubset(reader.fieldnames):
                raise ValueError("The CSV file does not contain the expected columns: 'Product', 'Quantity', 'Price'.")
