...
Generated at: 2025-04-03 15:30:21
...
def calculate_average(numbers: List[Union[int, float]]) -> Union[float, str]:
    ...
    Returns:
    Union[float, str]: The average of the numbers if the list is not empty,
                       otherwise a message indicating that the list is empty.
