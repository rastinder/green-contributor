...
Generated at: 2025-03-21 12:00:28
...
def calculate_statistics(df: pd.DataFrame) -> Dict[str, Dict[str, Any]]:
    """
    Calculate the mean, median, and standard deviation for each numeric column in the DataFrame.

    Parameters:
    df (pd.DataFrame): The input DataFrame containing the data to be analyzed.

    Returns:
    Dict[str, Dict[str, Any]]: A dictionary where the keys are column names and the values are dictionaries
    ...
    # Iterate over each numeric column and calculate the statistics
