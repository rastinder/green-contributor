...
Generated at: 2025-03-23 21:00:18
...
def process_data(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    """
    Processes data from a CSV file to calculate the mean and standard deviation for each column.
    ...
    Raises:
        ...
        ValueError: If there is an issue with the data in the CSV file.
    """
            ...
            for row in reader:
                for column, value in row.items():
                    ...
                    try:
                        ...
                        raise ValueError(f"Invalid data in column {column}: {value}")
