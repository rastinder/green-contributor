...
Generated at: 2025-03-24 20:00:10
...
def process_csv(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    try:
        ...
        with open(file_path, mode='r', newline='') as file:
            ...
            # Read the data and populate column_data
            for row in reader:
            ...
            for field in reader.fieldnames:
                means[field] = statistics.mean(column_data[field])
                std_devs[field] = statistics.stdev(column_data[field])

            # Combine means and standard deviations into a single dictionary
