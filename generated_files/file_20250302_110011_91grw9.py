...
Generated at: 2025-03-02 11:00:15
...
def process_csv(file_path: str) -> Tuple[Dict[str, float], Dict[str, float]]:
    ...
    Raises:
        ...
        ValueError: If there are non-numeric values in the numeric columns.
    """
    means = {}
    std_devs = {}
            ...
            for row in reader:
                for field in row:
                    try:
                        ...
                        raise ValueError(f"Non-numeric value found in column '{field}'")
