...
Generated at: 2025-03-26 08:30:10
...
def process_data(file_path: str) -> Union[Dict[str, Dict[str, float]], str]:
    ...
    Returns:
        Union[Dict[str, Dict[str, float]], str]: A dictionary with column names as keys and dictionaries
        containing 'mean' and 'std' as values, or an error message if an error occurs.
