...
Generated at: 2025-03-23 10:00:31
...
def process_and_analyze_data(file_path: str) -> Union[pd.DataFrame, dict]:
    """
    ...
    Returns:
    Union[pd.DataFrame, dict]: A dictionary containing the mean and standard deviation
                               for each numerical column, or an error message if an error occurs.
    ...
    try:
        ...
        for column in df_cleaned.select_dtypes(include='number').columns:
            ...
            analysis_results[column] = {'mean': mean, 'std_dev': std_dev}
