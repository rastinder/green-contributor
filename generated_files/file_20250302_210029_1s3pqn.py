...
Generated at: 2025-03-02 21:00:34
...
def analyze_dataframe(df: pd.DataFrame) -> Dict[str, Dict[str, float]]:
    """
    ...
    Returns:
    Dict[str, Dict[str, float]]: A dictionary where keys are column names and values are
                                  dictionaries containing 'mean', 'median', and 'std' keys
