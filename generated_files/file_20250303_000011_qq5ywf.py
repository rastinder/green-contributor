...
Generated at: 2025-03-03 00:00:16
...
def process_csv(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    try:
        ...
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            results = {column: {'mean': None, 'std_dev': None} for column in reader.fieldnames}
            ...
            for column in reader.fieldnames:
                if numeric_data[column]:
                    results[column]['mean'] = statistics.mean(numeric_data[column])
                    results[column]['std_dev'] = statistics.stdev(numeric_data[column])
                else:
