...
Generated at: 2025-03-22 09:30:10
...
def analyze_numeric_column(df: pd.DataFrame, column: str) -> Dict[str, Union[float, str]]:
    ...
    This function calculates the mean, median, and standard deviation of the specified
    ...
    Returns:
    Dict[str, Union[float, str]]: A dictionary containing the mean, median, and standard
                                   deviation of the specified column. If an error occurs,
