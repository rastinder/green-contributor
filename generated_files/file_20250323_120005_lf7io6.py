...
Generated at: 2025-03-23 12:00:10
...
def analyze_dataframe(df: pd.DataFrame) -> Dict[str, Dict[str, Union[float, int]]]:
    ...
    and the values are dictionaries containing 'mean', 'median', and 'std' as keys.
    ...
    analysis_results: Dict[str, Dict[str, Union[float, int]]] = {}
