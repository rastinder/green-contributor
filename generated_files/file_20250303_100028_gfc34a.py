...
Generated at: 2025-03-03 10:00:32
...
def process_and_analyze_data(file_path: str) -> Dict[str, Union[float, Dict[str, float]]]:
    ...
    and calculates the mean and standard deviation for each column
    of numerical data.
    ...
    Returns:
        Dict[str, Union[float, Dict[str, float]]]: A dictionary containing the total number of rows,
