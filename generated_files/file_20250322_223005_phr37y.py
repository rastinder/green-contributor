...
Generated at: 2025-03-22 22:30:10
...
def analyze_numeric_column(df: pd.DataFrame, column: str) -> Union[dict, str]:
    ...
    of the specified numeric column in the DataFrame.
    ...
    dict: A dictionary containing the mean, median, and standard deviation
          of the specified column. If an error occurs, returns an error message.
...
# Example usage:
# df = pd.DataFrame({'A': [1, 2, 3, 4, 5], 'B': [5.5, 2.5, 9.5, 3.5, 1.5]})
