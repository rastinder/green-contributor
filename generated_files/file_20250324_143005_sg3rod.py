...
Generated at: 2025-03-24 14:30:10
...
def calculate_average_from_csv(file_path: str, column_name: str) -> Union[float, str]:
    ...
    try:
        ...
        average_value = column_data.dropna().mean()

        # Check if the result is NaN (e.g., if the column was entirely non-numeric)
        if pd.isna(average_value):
            raise ValueError(f"Column '{column_name}' contains non-numeric values or is empty.")
