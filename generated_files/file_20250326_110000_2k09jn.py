...
Generated at: 2025-03-26 11:00:06
...
def process_sales_data(file_path: str) -> Dict[str, float]:
    """
    Process sales data from a CSV file and calculate the total sales for each product.
    ...
    try:
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            if 'Product' not in reader.fieldnames or 'Quantity' not in reader.fieldnames or 'Price' not in reader.fieldnames:
            ...
            for row in reader:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid data for product '{product}': Quantity and Price must be numeric.")
