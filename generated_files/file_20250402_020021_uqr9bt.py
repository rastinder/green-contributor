...
Generated at: 2025-04-02 02:00:26
...
def analyze_data(numbers: List[float]) -> Tuple[Union[float, None], Union[float, None], Union[float, None]]:
    ...
    Each value is a float if the calculation is successful, otherwise None.
    ...
    try:
        ...
        if len(numbers) > 1:
            ...
            std_dev = 0.0  # Standard deviation is not defined for a single number

    except statistics.StatisticsError as e:
        print(f"An error occurred during statistical calculations: {e}")
