...
Generated at: 2025-03-03 00:00:11
    ...
    try:
        with open(file_path, mode='r', newline='', encoding='utf-8') as csvfile:
            ...
            for row in reader:
                ...
                if not product_name or not sales:
                    raise ValueError("CSV file must contain 'Product' and 'Sales' columns.")

                try:
                    sales = float(sales)
                except ValueError:
                    raise ValueError(f"Invalid sales value '{sales}' for product '{product_name}'.")

                if product_name in sales_data:
                    sales_data[product_name] += sales
                else:
                    sales_data[product_name] = sales
