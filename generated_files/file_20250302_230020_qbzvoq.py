...
Generated at: 2025-03-02 23:00:27
...
def process_sales_data(file_path: str) -> Dict[str, Union[int, float]]:
    ...
    Returns:
        Dict[str, Union[int, float]]: A dictionary where keys are product names and values are total sales.
    ...
    try:
        ...
        total_sales = df.groupby('Product')['Total Sales'].sum().to_dict()
...
#     print(result)
# except Exception as e:
#     print(f"Failed to process sales data: {e}")
