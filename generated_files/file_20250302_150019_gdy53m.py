...
Generated at: 2025-03-02 15:00:24
...
def process_csv(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    """
    Process a CSV file to calculate the mean and median for each numerical column.
    ...
    Returns:
        ...
        dictionaries containing the mean and median values.
    ...
    try:
        ...
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            if not fieldnames:
                raise ValueError("The CSV file does not contain any columns.")

            # Initialize lists to store numerical data for each column
            column_data: Dict[str, List[float]] = {field: [] for field in fieldnames}
            ...
            for field, data in column_data.items():
                if data:
                    ...
                    results[field] = {'mean': mean, 'median': median}
                else:
                    results[field] = {'mean': 'N/A', 'median': 'N/A'}
