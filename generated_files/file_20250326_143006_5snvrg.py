...
Generated at: 2025-03-26 14:30:11
...
def process_csv(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    Returns:
        ...
        containing the mean and standard deviation for each numeric column.

    Raises:
        FileNotFoundError: If the file does not exist.
        ValueError: If the file is not a valid CSV or if there are issues with the data.
    """
    result = {}
    ...
    try:
        with open(file_path, mode='r', newline='') as file:
            ...
            # Initialize dictionaries to store sums and counts for each column
            sums = {field: 0 for field in reader.fieldnames}
            counts = {field: 0 for field in reader.fieldnames}
            ...
            for field in reader.fieldnames:
                if counts[field] > 0:
                    ...
                    std_dev = statistics.stdev(data[field]) if counts[field] > 1 else 0
                    result[field] = {
                        'mean': mean,
                        'std_dev': std_dev
                    }
