...
Generated at: 2025-03-28 18:00:40
...
def process_data(file_path: str) -> Tuple[Dict[str, float], Dict[str, float]]:
    ...
    Tuple[Dict[str, float], Dict[str, float]]: A tuple containing two dictionaries.
        The first dictionary holds the mean values for each numeric column.
        The second dictionary holds the standard deviation values for each numeric column.
    ...
    try:
        ...
        for column in df.columns:
            ...
            if pd.api.types.is_numeric_dtype(df[column]):
                ...
                std_dev_values[column] = df[column].std()
            else:
        ...
        print(f"Error: The file '{file_path}' is not in the correct format.")
        raise
...
# Example usage:
# mean_values, std_dev_values = process_data('data.csv')
