...
Generated at: 2025-03-27 05:30:14
...
def calculate_average_from_csv(file_path: str, column_name: str) -> Union[float, str]:
    """
    Calculate the average of a specified numeric column from a CSV file.
    ...
    str: An error message if the file is not found or the column is not numeric.
