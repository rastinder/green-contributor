...
Generated at: 2025-03-02 11:00:20
...
def process_and_analyze_data(file_path: str, column_name: str) -> Union[dict, str]:
    ...
    in the specified column, and then calculates the mean and median of the specified column.
    ...
    Returns:
    Union[dict, str]: A dictionary containing the mean and median of the specified column,
    ...
    try:
        ...
        if not pd.api.types.is_numeric_dtype(cleaned_data[column_name]):
