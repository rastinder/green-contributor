...
Generated at: 2025-03-02 15:00:19
...
def process_csv(file_path: str, column_name: str) -> Tuple[float, List[float]]:
    ...
    Returns:
    Tuple[float, List[float]]: A tuple containing the average of the specified column and a list of all values in that column.
...
# Example usage:
# average, values = process_csv('data.csv', 'ColumnName')
