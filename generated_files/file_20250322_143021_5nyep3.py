...
Generated at: 2025-03-22 14:30:25
...
def process_data(file_path: str, column_name: str) -> Tuple[Union[float, str], Union[float, str]]:
    """
    Process a CSV file to calculate the mean and standard deviation for a specified column.
        ...
        with open(file_path, mode='r', newline='') as file:
            ...
            for row in reader:
                try:
                    ...
                    return (f"Non-numeric data found in column '{column_name}'.", "")
