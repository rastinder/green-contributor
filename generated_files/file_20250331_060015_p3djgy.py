...
Generated at: 2025-03-31 06:00:19
...
def calculate_statistics(numbers: List[Union[int, float]]) -> Tuple[float, float]:
    ...
    This function takes a list of numbers (integers or floats) and returns a tuple
    containing the average and standard deviation of the numbers.

    Parameters:
    numbers (List[Union[int, float]]): A list of numbers to process.
...
if __name__ == "__main__":
    data = [10, 20, 30, 40, 50]
    try:
        avg, std_dev = calculate_statistics(data)
