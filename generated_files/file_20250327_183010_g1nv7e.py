...
Generated at: 2025-03-27 18:30:15
...
def analyze_dataframe(df: pd.DataFrame) -> Dict[str, Dict[str, Union[float, int]]]:
    ...
    Raises:
    ValueError: If the input is not a pandas DataFrame or if there are no numerical columns in the DataFrame.
    """
    ...
    # Iterate over each numerical column and calculate mean, median, and std
...
# Example usage:
# df = pd.DataFrame({'A': [1, 2, 3], 'B': [4.5, 5.5, 6.5], 'C': ['a', 'b', 'c']})
