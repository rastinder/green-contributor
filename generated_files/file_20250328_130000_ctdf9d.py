...
Generated at: 2025-03-28 13:00:06
...
def process_and_analyze_data(file_path: str, delimiter: str = ',') -> Optional[Dict[str, Any]]:
    """
    ...
    Returns:
    Optional[Dict[str, Any]]: A dictionary containing summary statistics if successful, otherwise None.
...
if __name__ == "__main__":
    file_path = 'data.csv'
    result = process_and_analyze_data(file_path)
    if result:
