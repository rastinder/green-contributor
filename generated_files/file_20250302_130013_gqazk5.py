...
Generated at: 2025-03-02 13:00:18
...
def process_and_analyze_data(file_path: str) -> Dict[str, Union[pd.DataFrame, pd.Series]]:
    """
    ...
    Returns:
    Dict[str, Union[pd.DataFrame, pd.Series]]: A dictionary containing the cleaned DataFrame and summary statistics.
