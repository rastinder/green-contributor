...
Generated at: 2025-03-26 17:30:18
...
def process_sales_data(file_path: str) -> Dict[str, float]:
    ...
    """
    # Dictionary to store total sales for each product category
    total_sales: Dict[str, float] = defaultdict(float)
        ...
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            for row in reader:
                ...
                try:
                    ...
                    print(f"Invalid sales value '{row['Sales']}' for category '{category}'. Skipping this entry.")
                    continue

                # Accumulate the sales for each category
