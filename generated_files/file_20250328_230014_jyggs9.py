...
Generated at: 2025-03-28 23:00:19
...
def calculate_average_column_value(file_path: str, column_name: str) -> Union[float, str]:
    """
    ...
    Returns:
    - Union[float, str]: The average value of the specified column or an error message if the column is not found.
        ...
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            for row in reader:
                try:
                    ...
                    print(f"Warning: Non-numeric value '{row[column_name]}' found in column '{column_name}'. Skipping.")
...
# Example usage:
# result = calculate_average_column_value('data.csv', 'age')
# print(result)
