...
Generated at: 2025-03-29 14:00:14
...
def calculate_average_from_csv(file_path: str, column_name: str) -> Union[float, str]:
    """
    Calculate the average of a specified column from a CSV file.
    ...
    ValueError: If the column name does not exist in the CSV file or if the column contains non-numeric values.
    """
    try:
        # Open the CSV file
        with open(file_path, mode='r', newline='') as file:
            ...
            # Check if any numeric values were found in the column
            if count == 0:
