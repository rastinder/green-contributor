...
Generated at: 2025-03-04 00:30:07
...
def process_sales_data(file_path: str) -> Tuple[Dict[str, float], str]:
    """
    ...
    Returns:
        Tuple[Dict[str, float], str]: A dictionary with product categories as keys and total sales as values,
    ...
    try:
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            for row in reader:
                ...
                try:
                    sales_amount = float(row['SalesAmount'])
                except ValueError:
                    raise ValueError(f"Invalid sales amount in row: {row}")
        ...
        return sales_data, "Data processing completed successfully."
...
# Example usage:
# result, message = process_sales_data('sales_data.csv')
# print(message)
# print(result)
