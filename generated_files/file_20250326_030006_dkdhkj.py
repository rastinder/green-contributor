...
Generated at: 2025-03-26 03:00:10
...
def calculate_average(data_file: str, column_name: str) -> Union[float, str]:
    """
    ...
    try:
        ...
        return f"Error: The file '{data_file}' does not exist."
...
if __name__ == "__main__":
    result = calculate_average("data.csv", "salary")
    print(result)
