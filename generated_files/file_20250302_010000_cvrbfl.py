...
Generated at: 2025-03-02 01:00:05
...
def process_csv(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    Returns:
        Dict[str, Dict[str, Union[float, str]]]: A dictionary where the key is the column name and the value is another dictionary
        containing the mean and standard deviation of that column.

    Raises:
        FileNotFoundError: If the specified file does not exist.
        ValueError: If the CSV file is empty or contains non-numeric data in numerical columns.
    """
    results = {}
        ...
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            for field in reader.fieldnames:
                if data[field]:
                    ...
                    stdev = statistics.stdev(data[field])
                    results[field] = {
                        'mean': mean,
                        'stdev': stdev
                    }
