...
Generated at: 2025-03-27 13:00:13
...
def process_csv(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    Raises:
        ...
        ValueError: If the file is not a valid CSV file or if there are non-numeric values in the columns.
    """
    try:
        ...
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            for field in reader.fieldnames:
                if column_data[field]:
                    ...
                    result[field] = {'mean': mean, 'stdev': stdev}
                else:
                    result[field] = {'mean': 'N/A', 'stdev': 'N/A'}
        ...
        raise ValueError(f"The file at {file_path} is not a valid CSV file.")
