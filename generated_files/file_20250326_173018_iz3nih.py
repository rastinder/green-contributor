...
Generated at: 2025-03-26 17:30:23
...
def process_data(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    Returns:
        Dict[str, Dict[str, Union[float, str]]]: A dictionary containing the mean and standard deviation
                                                  for each column. Each key is a column name, and the value
                                                  is another dictionary with 'mean' and 'std' keys.
    ...
    try:
        ...
        for column in df.columns:
            try:
                ...
                results[column] = {
                    'mean': 'Error calculating mean',
                    'std': 'Error calculating std',
                    'error': str(e)
                }
