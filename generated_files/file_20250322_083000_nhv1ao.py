...
Generated at: 2025-03-22 08:30:05
    ...
    try:
        ...
        with open(file_path, mode='r', newline='') as file:
            ...
            for row in csv_reader:
                try:
                    # Convert the column value to a float and add it to the total
                    value = float(row[column_name])
                    total += value
                    count += 1
                except ValueError:
                    # Handle non-numeric values
                    raise ValueError(f"Non-numeric value found in column '{column_name}': {row[column_name]}")
