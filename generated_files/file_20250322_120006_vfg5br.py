...
Generated at: 2025-03-22 12:00:10
...
def analyze_numeric_columns(df: pd.DataFrame) -> Dict[str, Dict[str, Union[float, str]]]:
    """
    Analyze numeric columns in a pandas DataFrame by calculating the mean, median, and standard deviation.
    ...
    containing the mean, median, and standard deviation of each numeric column.
...
#     'C': ['a', 'b', 'c', 'd', 'e']
# })
# print(analyze_numeric_columns(df))
