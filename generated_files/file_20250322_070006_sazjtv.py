...
Generated at: 2025-03-22 07:00:10
...
def process_data(file_path: str, column_name: str) -> Tuple[float, float, Union[int, float]]:
    """
    Process data from a CSV file by calculating the mean, median, and mode of a specified column.
    ...
    Returns:
    Tuple[float, float, Union[int, float]]: A tuple containing the mean, median, and mode of the specified column.
