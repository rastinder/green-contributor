...
Generated at: 2025-03-30 22:00:18
...
def analyze_numbers(numbers: List[float]) -> Tuple[Union[float, None], Union[float, None], Union[float, None]]:
    ...
    Each value can be a float or None if the computation is not possible (e.g., empty list).
    ...
    try:
        ...
        std_dev = statistics.stdev(numbers) if len(numbers) > 1 else None
...
if __name__ == "__main__":
    try:
        ...
        avg, med, std = analyze_numbers(numbers)
