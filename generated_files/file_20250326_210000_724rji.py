...
Generated at: 2025-03-26 21:00:06
...
def process_sales_data(file_path: str) -> Dict[str, float]:
    ...
    try:
        with open(file_path, mode='r', newline='', encoding='utf-8') as csvfile:
            ...
            expected_columns = {'Product', 'Category', 'Sales'}
            if not expected_columns.issubset(reader.fieldnames):
                raise ValueError("The CSV file does not have the expected columns: 'Product', 'Category', 'Sales'.")
