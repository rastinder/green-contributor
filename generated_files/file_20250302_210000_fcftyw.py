...
Generated at: 2025-03-02 21:00:07
...
def analyze_data(df: pd.DataFrame) -> Dict[str, Union[float, Dict[str, float]]]:
    ...
    Returns:
    Dict[str, Union[float, Dict[str, float]]]: A dictionary containing the mean, median,
    and standard deviation of numerical columns.
    ...
    mean_values = numerical_columns.mean().to_dict()
    median_values = numerical_columns.median().to_dict()
    std_values = numerical_columns.std().to_dict()
