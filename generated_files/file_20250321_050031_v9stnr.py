...
Generated at: 2025-03-21 05:00:35
...
def analyze_numeric_column(df: pd.DataFrame, column: str) -> Dict[str, Any]:
    """
    ...
    in the given DataFrame. It handles errors such as missing columns or non-numeric data.
    ...
    Returns:
    Dict[str, Any]: A dictionary containing the mean, median, and standard deviation of the specified column.
...
# result = analyze_numeric_column(df, 'numeric_column')
# print(result)
