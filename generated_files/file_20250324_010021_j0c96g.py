...
Generated at: 2025-03-24 01:00:26
...
def calculate_average_from_csv(file_path: str, column_name: str) -> Union[float, str]:
    ...
    Raises:
        ...
        ZeroDivisionError: If the column contains no numeric data.
    """
    try:
        # Open the CSV file
        with open(file_path, mode='r', newline='') as file:
            ...
            # Check if there is any numeric data in the column
            if count == 0:
                raise ZeroDivisionError(f"No numeric data found in column '{column_name}'.")
