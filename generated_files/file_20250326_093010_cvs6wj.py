...
Generated at: 2025-03-26 09:30:15
...
def analyze_column(df: pd.DataFrame, column: str) -> Dict[str, Union[float, str]]:
    ...
    if column not in df.columns:
        return {"error": f"The column '{column}' does not exist in the DataFrame."}
    ...
    try:
        ...
        return {"error": f"The column '{column}' contains non-numeric data. Error: {str(e)}"}
