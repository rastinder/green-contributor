...
Generated at: 2025-04-02 10:00:16
...
def calculate_statistics(data: List[float]) -> Tuple[float, float]:
    ...
    Parameters:
    data (List[float]): A list of numerical values (floats).

    Returns:
    Tuple[float, float]: A tuple containing the mean and standard deviation of the input data.
