...
Generated at: 2025-03-24 16:00:15
...
def analyze_dataframe(df: pd.DataFrame) -> Dict[str, Dict[str, Union[float, str]]]:
    """
    Analyze a pandas DataFrame by calculating the mean, median, and standard deviation for each numeric column.
    ...
    Dict[str, Dict[str, Union[float, str]]]: A dictionary where keys are column names and values are dictionaries
                                              containing the mean, median, and standard deviation of each column.
