...
Generated at: 2025-03-27 16:00:10
...
def process_sales_data(file_path: str) -> Dict[str, Any]:
    ...
    This function reads a CSV file containing sales data, performs basic data cleaning,
    and returns a summary of the sales data.

    Parameters:
    file_path (str): The path to the CSV file containing sales data.

    Returns:
    Dict[str, Any]: A dictionary containing the summary of the sales data.
    ...
    try:
        ...
        # Drop rows where 'Sales' conversion failed
...
# Example usage:
# summary = process_sales_data('sales_data.csv')
# print(summary)
