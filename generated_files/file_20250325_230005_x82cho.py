...
Generated at: 2025-03-25 23:00:10
...
def process_data(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    Returns:
        Dict[str, Dict[str, Union[float, str]]]: A dictionary with column names as keys and dictionaries containing
        the mean and standard deviation as values.
    ...
    try:
        ...
        for column in df.columns:
            if pd.api.types.is_numeric_dtype(df[column]):
                ...
                # For non-numeric columns, provide a message
                results[column] = {
                    'mean': 'N/A',
                    'std_dev': 'N/A'
                }
