...
Generated at: 2025-03-03 10:00:28
...
def process_csv(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    Raises:
        ...
        ValueError: If the CSV file is empty or contains non-numeric data in columns expected to be numeric.
    """
    results = {}
        ...
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            for field in reader.fieldnames:
                if data[field]:
                    ...
                    results[field] = {'mean': mean, 'stdev': stdev}
                else:
                    results[field] = {'mean': 'N/A', 'stdev': 'N/A'}
