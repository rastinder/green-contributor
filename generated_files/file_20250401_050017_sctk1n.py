...
Generated at: 2025-04-01 05:00:22
...
def calculate_average_salary(employees: List[Dict[str, Union[str, float]]], department: str) -> float:
    ...
    Parameters:
    employees (List[Dict[str, Union[str, float]]]): A list of dictionaries where each dictionary contains
                                                   the keys 'name', 'department', and 'salary'.
