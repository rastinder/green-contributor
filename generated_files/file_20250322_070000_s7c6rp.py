...
Generated at: 2025-03-22 07:00:06
...
def analyze_csv(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    """
    Analyze a CSV file to compute the mean and standard deviation for each numerical column.
    ...
    try:
        ...
        for column in df.columns:
            if pd.api.types.is_numeric_dtype(df[column]):
                ...
                # If the column is not numeric, store a message
                results[column] = {
                    'mean': 'N/A',
                    'std_dev': 'N/A'
                }
