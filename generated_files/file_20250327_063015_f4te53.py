...
Generated at: 2025-03-27 06:30:19
...
def process_data(file_path: str, column_name: str) -> Union[Tuple[float, float], str]:
    """
    ...
    Returns:
    Union[Tuple[float, float], str]: A tuple containing the mean and standard deviation if successful,
    ...
    try:
        ...
        # Check for NaN values in the numeric column
        if numeric_column.isna().any():
            return f"Error: Column '{column_name}' contains non-numeric data."
