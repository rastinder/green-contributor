...
Generated at: 2025-03-22 19:30:06
...
def process_and_analyze_data(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    """
    Reads a CSV file, processes the data to compute the mean and standard deviation
    for each numeric column, and returns the results as a dictionary.
    ...
    ValueError: If the file is not a valid CSV file or contains non-numeric data.
    """
    try:
