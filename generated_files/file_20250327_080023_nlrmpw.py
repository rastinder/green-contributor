...
Generated at: 2025-03-27 08:00:28
...
def process_data(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    Returns:
        ...
        dictionaries containing the mean and standard deviation of the column.
    ...
    try:
        ...
        for column in df.columns:
            if df[column].dtype in ['int64', 'float64']:  # Check if the column contains numeric data
                mean = df[column].mean()
        ...
        raise pd.errors.ParserError("There was an error parsing the file.")
