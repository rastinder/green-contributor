...
Generated at: 2025-03-25 10:00:46
...
def process_data(file_path: str) -> Union[Dict[str, Dict[str, float]], str]:
    ...
    Returns:
        Union[Dict[str, Dict[str, float]], str]: A dictionary with column names as keys and another dictionary
        containing 'mean' and 'std' as keys, or an error message if an error occurs.
