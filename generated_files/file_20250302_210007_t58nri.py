...
Generated at: 2025-03-02 21:00:11
...
def process_data(file_path: str, column_name: str) -> Tuple[Union[float, str], Union[float, str]]:
    ...
    ValueError: If the column does not contain numeric data.
    """
    try:
        ...
        return f"Error: The column '{column_name}' does not contain numeric data.", ""
    except Exception as e:
        return f"An unexpected error occurred: {str(e)}", ""

# Example usage:
# mean, std = process_data('data.csv', 'column_name')
