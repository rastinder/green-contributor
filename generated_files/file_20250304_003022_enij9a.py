...
Generated at: 2025-03-04 00:30:28
...
def analyze_dataframe(df: pd.DataFrame) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    TypeError: If the DataFrame does not contain any numerical columns.
    """
    ...
    if numerical_columns.empty:
        raise TypeError("The DataFrame does not contain any numerical columns.")
