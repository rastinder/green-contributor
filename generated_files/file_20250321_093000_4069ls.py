...
Generated at: 2025-03-21 09:30:05
...
def process_and_analyze_data(file_path: str, column_name: str) -> Tuple[float, float]:
    ...
    Raises:
        ...
        KeyError: If the column specified by column_name does not exist in the DataFrame.
        ValueError: If the column specified by column_name contains non-numeric values.
    """
    try:
        ...
        # Drop rows where the conversion to numeric failed (i.e., NaN values)
