...
Generated at: 2025-03-24 03:00:19
...
def process_csv(file_path: str, column_name: str) -> Tuple[Union[float, str], Union[float, str]]:
    ...
    try:
        ...
        with open(file_path, mode='r', newline='') as file:
            ...
            if not data:
                return "No valid data found in the specified column", "No valid data found in the specified column"
...
# Example usage:
# mean, stdev = process_csv('data.csv', 'column_name')
