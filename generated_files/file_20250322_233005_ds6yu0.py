...
Generated at: 2025-03-22 23:30:10
...
def process_data(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    Returns:
        Dict[str, Dict[str, Union[float, str]]]: A dictionary where the key is the column name,
                                                  and the value is another dictionary containing
                                                  the mean and standard deviation of that column.
