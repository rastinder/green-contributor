...
Generated at: 2025-03-02 11:00:25
...
def process_sales_data(file_path: str) -> Dict[str, float]:
    ...
    try:
        ...
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            for row in reader:
                # Ensure the row has the expected keys
                if 'product' not in row or 'sales' not in row:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid sales value for product '{product}': {row['sales']}")
