...
Generated at: 2025-03-02 11:00:11
...
def analyze_data(file_path: str) -> Dict[str, Union[float, str]]:
    """
    ...
    Returns:
    Dict[str, Union[float, str]]: A dictionary with the mean and standard deviation for each numerical column.
    ...
    try:
        ...
        return {'error': 'File is not a valid CSV.'}
