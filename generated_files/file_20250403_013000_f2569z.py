...
Generated at: 2025-04-03 01:30:05
...
def calculate_statistics(numbers: List[float]) -> Tuple[Optional[float], Optional[float]]:
    """
    ...
    Returns:
    Tuple[Optional[float], Optional[float]]: A tuple containing the average and standard deviation.
