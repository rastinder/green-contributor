...
Generated at: 2025-03-03 14:00:14
...
def analyze_numeric_data(df: pd.DataFrame) -> Dict[str, Dict[str, Union[float, str]]]:
    """
    Analyze the numeric columns of a DataFrame by calculating the mean, median, and standard deviation.
    ...
    containing 'mean', 'median', and 'std' as keys with their respective values.

    Raises:
    ValueError: If the input DataFrame is empty or does not contain any numeric columns.
    """
    ...
    # Iterate over each numeric column and calculate mean, median, and std
