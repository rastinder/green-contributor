...
Generated at: 2025-03-26 00:30:18
...
def analyze_dataframe(df: pd.DataFrame) -> Dict[str, Dict[str, float]]:
    ...
    Returns:
    Dict[str, Dict[str, float]]: A dictionary where the keys are column names and the values
                                  are dictionaries containing 'mean', 'median', and 'std' values.
