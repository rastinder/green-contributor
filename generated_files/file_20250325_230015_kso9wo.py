...
Generated at: 2025-03-25 23:00:19
...
def process_sales_data(file_path: str) -> Dict[str, Any]:
    """
    Processes sales data from a CSV file and calculates the total sales for each product category.

    Args:
        file_path (str): The path to the CSV file containing sales data.

    Returns:
        Dict[str, Any]: A dictionary containing the total sales for each product category.
