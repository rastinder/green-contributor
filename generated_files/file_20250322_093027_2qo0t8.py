...
Generated at: 2025-03-22 09:30:32
...
def process_sales_data(file_path: str) -> Dict[str, Union[int, float]]:
    ...
    Returns:
        Dict[str, Union[int, float]]: A dictionary where keys are product names
                                      and values are the total sales for each product.
    ...
    try:
        ...
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            if not required_columns.issubset(reader.fieldnames):
                raise ValueError("The CSV file must contain 'Product', 'Quantity', and 'Price' columns.")
