...
Generated at: 2025-03-02 20:00:08
...
def analyze_dataframe(df: pd.DataFrame) -> Dict[str, Dict[str, Union[float, str]]]:
    """
    Analyze a pandas DataFrame to calculate the mean, median, and standard deviation for each numerical column.
    ...
    Dict[str, Dict[str, Union[float, str]]]: A dictionary where the keys are column names and the values are
                                              dictionaries containing the mean, median, and standard deviation.
    ...
    # Iterate over each numerical column and calculate mean, median, and standard deviation
