...
Generated at: 2025-03-03 06:30:10
...
def process_sales_data(file_path: str) -> Dict[str, float]:
    """
    Processes sales data from a CSV file and calculates the total sales for each product.
    ...
    Raises:
        ...
        ValueError: If there is an error in the data format.
    """
    ...
    try:
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            if not required_columns.issubset(reader.fieldnames):
                raise ValueError("CSV file must contain 'Date', 'Product', 'Quantity', and 'Price' columns.")
