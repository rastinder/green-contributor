...
Generated at: 2025-03-21 09:30:10
...
def process_and_analyze_data(file_path: str, column_name: str) -> Tuple[float, List[float]]:
    """
    Process a CSV file to calculate the average of a specified column and return the average and a list of values.
    ...
    Returns:
        Tuple[float, List[float]]: A tuple containing the average of the specified column and a list of values from that column.
        ...
        with open(file_path, mode='r', newline='') as csvfile:
            ...
            for row in reader:
                try:
                    ...
                    print(f"Warning: Non-numeric value '{row[column_name]}' in column '{column_name}' will be skipped.")
