...
Generated at: 2025-03-02 14:00:17
...
def process_csv(file_path: str) -> Dict[str, Dict[str, Union[float, str]]]:
    ...
    Returns:
        Dict[str, Dict[str, Union[float, str]]]: A dictionary containing the mean and standard deviation
                                                 for each column. The keys are column names, and the values
                                                 are dictionaries with 'mean' and 'std' keys.
        ...
        with open(file_path, mode='r', newline='') as file:
            ...
            for field, data in column_data.items():
                if data:
                    ...
                    results[field] = {'mean': mean, 'std': std_dev}
                else:
                    results[field] = {'mean': 'N/A', 'std': 'N/A'}
