...
# Large snippet for ensuring 100+ line commits
large_snippet = '''def data_structures_and_algorithms():
    class Node:
...
def get_large_snippet():
    """Returns the large code snippet"""
    return large_snippet
